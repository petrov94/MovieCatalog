...
<p><font size="8">REGISTRATION</font></p>
		<table bgcolor="white" border="1" cellpadding="5" cellspacing="5">
			<tr bgcolor="white">
				...
				<td><input type="text" class="INPUTp" name="user_name" value="<%=request.getAttribute("user_name")%>"></td>
			</tr>
			<tr bgcolor="white">
				<td>Password: <br>Between 6 and 25 characters</td>
				<td><input type="text" class="INPUTp" name="password"value="<%=request.getAttribute("password")%>"></td>
			</tr>
			<tr bgcolor="white">
				<td>Repeat Password:</td>
				<td><input type="text"  class="INPUTp" name="password_again"value="<%=request.getAttribute("password_again")%>"></td>
			</tr>
			<tr>
